...
class Imprimir2 extends React.Component {
  ...
  Imprimir(){
    ...
    var costoEPG = this.props.costos.epg; 
    var costoUPG = this.props.costos.upg; 
    var dcostoTotal = this.props.costos.d_total; 
    var dcostoEPG = this.props.costos.d_epg; 
    var dcostoUPG = this.props.costos.d_upg; 
    var costo_TOTAL = this.props.costos._Total;
    var dcosto_TOTAL = this.props.costos.d_Total;
    var costo_tipo = this.props.costos.tipo;
...
console.log(listadoFinalBeneficio);
    ...
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Total costo real", 35, 330);
    ...
    doc.setFontType("normal");
    doc.setFontSize(8);
    doc.text("", 160, 290); //AQUI VA EL DERECHO DE ENSEÑANZA DEL COSTO REAL

    if(costoTotal!=null){
      doc.setFont("helvetica");
      doc.setFontType("normal");
      doc.setFontSize(9);
      doc.text("S/. "+costoTotal.toString(), 160, 310); //AQUI VA EL TOTAL DEL COSTO REAL
    }else{
      doc.setFont("helvetica");
      doc.setFontType("normal");
      doc.setFontSize(9);
    ...
    if(costo_TOTAL!=null){
      ...
      doc.setFontType("normal");
      doc.setFontSize(9);
      doc.text("S/. "+costo_TOTAL.toString(), 160, 330); //AQUI VA EL TOTAL DEL COSTO REAL
    }else{
      doc.setFont("helvetica");
      doc.setFontType("normal");
      doc.setFontSize(9);
    ...
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Total costo final", 500, 330);

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Descuento aplicado a", 500, 350);
    ...
    if(dcostoTotal!=null){
      ...
      doc.setFontType("normal");
      doc.setFontSize(9);
      doc.text("S/. "+dcostoTotal.toString(), 620, 310); //AQUI VA EL TOTAL DEL COSTO FINAL
    }else{
      doc.setFont("helvetica");
      doc.setFontType("normal");
      doc.setFontSize(9);
    ...
    if(dcosto_TOTAL!=null){
      ...
      doc.setFontType("normal");
      doc.setFontSize(9);
      doc.text("S/. "+dcosto_TOTAL.toString(), 620, 330); //AQUI VA EL TOTAL DEL COSTO FINAL
    }else{
      doc.setFont("helvetica");
      doc.setFontType("normal");
      doc.setFontSize(9);
