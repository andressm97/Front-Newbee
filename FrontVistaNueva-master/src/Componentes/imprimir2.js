...
class Imprimir2 extends React.Component {
  ...
  console.log(listadoFinalFormato);
    ...
    doc.setFontType("bold");
    doc.setFontSize(12);
    doc.text("ESTADO DE PAGOS", 35, 100); 
    ...
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Beneficio", 35, 232);

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Autorizacion", 35, 252);

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Condicion", 300, 232);

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Fecha", 300, 252);

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(9);
    doc.text("Resolución", 550, 232);
    ...
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 140, 324); //AQUI VA LA MATRICULA UPG DEL COSTO REAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 140, 344); //AQUI VA LA MATRICULA EPG DEL COSTO REAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 140, 364); //AQUI VA EL DERECHO DE ENSEÑANZA DEL COSTO REAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 140, 384); //AQUI VA EL TOTAL DEL COSTO REAL
    ...
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 610, 324); //AQUI VA LA MATRICULA UPG DEL COSTO FINAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 610, 344); //AQUI VA LA MATRICULA EPG DEL COSTO FINAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 610, 364); //AQUI VA EL DERECHO DE ENSEÑANZA DEL COSTO FINAL

    doc.setFont("helvetica");
    doc.setFontType("bold");
    doc.setFontSize(8);
    doc.text("", 610, 384); //AQUI VA EL TOTAL DEL COSTO FINAL
...
/*
        ...
        doc.setPage(n);
        doc.text(35,585,listafinal[0][0].apeNom);
